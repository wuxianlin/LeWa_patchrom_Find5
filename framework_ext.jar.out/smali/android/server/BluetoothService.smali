...
.method private native enterTestModeNative()I
.end method
...
.method private native quitTestModeNative()I
.end method
...
.method public declared-synchronized closeRemoteGattService(Ljava/lang/String;I)V
    ...
    .line 5077
    iget-object v7, p0, Landroid/server/BluetoothService;->mGattServices:Ljava/util/SortedMap;

    invoke-interface {v7, p1}, Ljava/util/SortedMap;->containsKey(Ljava/lang/Object;)Z
    ...
    const-string/jumbo v9, "removeRemoteGattService: service not found "
    ...
    .line 5083
    .local v4, refCount:Ljava/lang/Integer;
    invoke-virtual {v4}, Ljava/lang/Integer;->intValue()I
    ...
    const-string/jumbo v9, "removeRemoteGattService: refCount for "
    ...
    iget-object v7, p0, Landroid/server/BluetoothService;->usedSrvIds:Ljava/util/ArrayList;
    ...
    const-string v9, "Removing service Id "
    ...
    const-string v9, "from used service list"
    ...
    invoke-interface {v7, p1}, Ljava/util/SortedMap;->remove(Ljava/lang/Object;)Ljava/lang/Object;

    .line 5094
    iget-object v7, p0, Landroid/server/BluetoothService;->mGattServices:Ljava/util/SortedMap;

    invoke-interface {v7, p1, v4}, Ljava/util/SortedMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    .end local v4           #refCount:Ljava/lang/Integer;
    :catchall_0
    move-exception v7
    ...
    .line 5098
    .restart local v3       #objPath:Ljava/lang/String;
    .restart local v4       #refCount:Ljava/lang/Integer;
    :cond_2
    :try_start_2
    ...
    const-string v8, "adress is null????"
    ...
    invoke-interface {v7, v1}, Ljava/util/SortedMap;->tailMap(Ljava/lang/Object;)Ljava/util/SortedMap;

    move-result-object v6

    .line 5117
    .local v6, subMap:Ljava/util/SortedMap;
    ...
    const-string/jumbo v9, "removeRemoteGattService: more GATT services are running on device "
    ...
    const-string/jumbo v9, "removeRemoteGattService: disconnect"
    ...
    const-string v9, "disconnectGatt "
...
.method public declared-synchronized discoverCharacteristics(Ljava/lang/String;I)Z
    ...
    const-string v8, "discoverCharacteristics Id : "
    ...
    const-string v8, "Service not present "
    ...
    .local v5, ret:Z
    :try_start_2
    iget-object v6, p0, Landroid/server/BluetoothService;->mGattOperationTracker:Ljava/util/HashMap;

    const-string v7, "discoverChar"
    ...
    .line 4733
    .local v2, objPathSrvIdList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    new-instance v6, Ljava/lang/StringBuilder;
    ...
    .line 4734
    .local v4, pathSrvId:Ljava/lang/String;
    if-eqz v2, :cond_6
    ...
    const-string/jumbo v7, "objPathSrvIdList not null"
    ...
    const-string/jumbo v8, "objPathSrvIdList length:"
    ...
    .line 4739
    .local v3, objSvId:Ljava/lang/String;
    const-string v6, "#"
    ...
    const-string/jumbo v7, "srv path is not already registered for discover char in mGattOperationTracker"
    ...
    const-string v8, "Calling discoverCharacteristicsNative "
    ...
    invoke-direct {p0, p1, v6}, Landroid/server/BluetoothService;->discoverCharacteristicsNative(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    const-string/jumbo v7, "srv path is already registered for discover char in mGattOperationTracker. So will not call discover char again"
    ...
    .end local v1           #i:I
    .end local v3           #objSvId:Ljava/lang/String;
    :cond_6
    const-string v6, "BluetoothService"

    const-string/jumbo v7, "objPathSrvIdList is null"
    ...
    .end local v2           #objPathSrvIdList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    invoke-direct {v2}, Ljava/util/ArrayList;-><init>()V

    .line 4762
    .restart local v2       #objPathSrvIdList:Ljava/util/ArrayList;,"Ljava/util/ArrayList<Ljava/lang/String;>;"
    invoke-virtual {v2, v4}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z
...
.method public declared-synchronized enterTestMode()I
    ...
    :try_start_0
    invoke-direct {p0}, Landroid/server/BluetoothService;->enterTestModeNative()I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized quitTestMode()I
    .locals 1
    ...
    :try_start_0
    invoke-direct {p0}, Landroid/server/BluetoothService;->quitTestModeNative()I
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public removeAllDeviceBONDED()V
    .locals 8
    ...
    invoke-virtual {v4, v5}, Landroid/server/BluetoothBondState;->listInState(I)[Ljava/lang/String;
    ...
    invoke-virtual {p0, v4, v5, v6}, Landroid/server/BluetoothService;->setBondState(Ljava/lang/String;II)Z

    .line 5751
    const-string v4, "UUIDs"

    invoke-virtual {p0, v0, v4, v7}, Landroid/server/BluetoothService;->setRemoteDeviceProperty(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v0, v4, v5}, Landroid/server/BluetoothService;->setRemoteDeviceProperty(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 5754
    invoke-virtual {p0, v0}, Landroid/server/BluetoothService;->clearRemoteDeviceGattServices(Ljava/lang/String;)V
