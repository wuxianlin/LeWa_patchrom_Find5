...
.method public setInterfaceConfig(Ljava/lang/String;Landroid/net/InterfaceConfiguration;)V
    ...
    .line 663
    .local v0, cmd:Lcom/android/server/NativeDaemonConnector$Command;
    invoke-direct {p0, p1, v4}, Lcom/android/server/NetworkManagementService;->setCommand(Ljava/lang/String;Landroid/net/LinkAddress;)Lcom/android/server/NativeDaemonConnector$Command;
...
.method private setCommand(Ljava/lang/String;Landroid/net/LinkAddress;)Lcom/android/server/NativeDaemonConnector$Command;
    .locals 11
    .parameter "iface"
    .parameter "linkAddr"
    ...
    const-string v4, "wifi_softap_netmask"

    invoke-static {v3, v4}, Landroid/provider/Settings$System;->getString(Landroid/content/ContentResolver;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v2

    .local v2, mSoftApNetMask:Ljava/lang/String;
    if-eqz v2, :cond_0
    ...
    :cond_1
    const-string v3, "ro.lewa.wifi_softap_netmask"
    ...
    invoke-virtual {p2}, Landroid/net/LinkAddress;->getNetworkPrefixLength()I
    ...
    .local v1, mCmd:Lcom/android/server/NativeDaemonConnector$Command;
    :goto_0
    move-object v0, v1
    ...
    .end local v0           #cmd:Lcom/android/server/NativeDaemonConnector$Command;
    .end local v1           #mCmd:Lcom/android/server/NativeDaemonConnector$Command;
    :cond_2
    new-instance v1, Lcom/android/server/NativeDaemonConnector$Command;
    ...
    .restart local v1       #mCmd:Lcom/android/server/NativeDaemonConnector$Command;
    goto :goto_0
.end method
