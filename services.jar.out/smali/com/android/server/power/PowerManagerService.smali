...
.field private static final A_STEP:J = 0x493e0L
...
.field private static final DEBUG_DISPLAY_CONTROLER_MASK:I = 0x1

.field private static final DEBUG_DISPLAY_POWER_STATE_MASK:I = 0x8

.field private static final DEBUG_ELECTRON_BEAM_MASK:I = 0x10

.field private static final DEBUG_NOTIFIER_MASK:I = 0x4

.field private static final DEBUG_POWERMANAGER_MASK:I = 0x2

.field private static DEBUG_SPEW:Z = false

.field private static final DEBUG_WIRELESS_CHARGE_MASK:I = 0x20
...
.method static constructor <clinit>()V
    ...
    sput-wide v3, Lcom/android/server/power/PowerManagerService;->mLogFlag:J
...
.method static synthetic access$1100(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/Notifier;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1202(Lcom/android/server/power/PowerManagerService;Z)Z
    ...
    .prologue
    .line 89
    iput-boolean p1, p0, Lcom/android/server/power/PowerManagerService;->mSendGoToSleepFinishedNotificationWhenReady:Z
...
.method static synthetic access$1500(Lcom/android/server/power/PowerManagerService;J)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method static synthetic access$1700(Lcom/android/server/power/PowerManagerService;)Landroid/content/Context;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1800(Lcom/android/server/power/PowerManagerService;)Ljava/lang/Object;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3300(Lcom/android/server/power/PowerManagerService;)Lcom/android/server/power/PowerManagerService$PowerManagerHandler;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$3700(Lcom/android/server/power/PowerManagerService;)Landroid/os/UEventObserver;
    .locals 1
    .parameter "x0"
...
.method private assertCheck()V
    ...
    iget-object v13, v0, Lcom/android/server/power/PowerManagerService;->mAssertUncheck:[Ljava/lang/String;
    ...
    .line 3104
    iget-object v13, v12, Lcom/android/server/power/PowerManagerService$WakeLock;->mTag:Ljava/lang/String;

    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/server/power/PowerManagerService;->mAssertUncheck:[Ljava/lang/String;
    ...
    .line 3108
    const-string v13, "AssertLock"

    new-instance v14, Ljava/lang/StringBuilder;

    invoke-direct {v14}, Ljava/lang/StringBuilder;-><init>()V

    const-string v15, "Uncheck "
    ...
    const-string v15, " hold walk "

    invoke-virtual {v14, v15}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v14

    iget-wide v15, v12, Lcom/android/server/power/PowerManagerService$WakeLock;->mAssertTime:J
    ...
    .line 3112
    :cond_3
    iget-wide v13, v12, Lcom/android/server/power/PowerManagerService$WakeLock;->mAssertTime:J
    ...
    .line 3117
    iget v13, v12, Lcom/android/server/power/PowerManagerService$WakeLock;->mOwnerPid:I

    iget v14, v12, Lcom/android/server/power/PowerManagerService$WakeLock;->mOwnerUid:I

    move-object/from16 v0, p0

    invoke-direct {v0, v13, v14}, Lcom/android/server/power/PowerManagerService;->assertUidInfo(II)Landroid/app/ActivityManager$RunningAppProcessInfo;
    ...
    .line 3120
    iget-object v13, v6, Landroid/app/ActivityManager$RunningAppProcessInfo;->processName:Ljava/lang/String;
    ...
    .line 3132
    const-string v13, " when screen off."
    ...
    invoke-static {v13, v2}, Ljava/lang/ASSERT;->fail(Ljava/lang/String;Ljava/lang/String;)V
...
.method private assertOnScreenOff()V
    ...
    iget-object v2, p0, Lcom/android/server/power/PowerManagerService;->mAssertCheck:Ljava/lang/Runnable;

    const-wide/32 v3, 0x927c0

    invoke-virtual {v0, v2, v3, v4}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->postDelayed(Ljava/lang/Runnable;J)Z
...
.method private assertOnScreenOn()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/power/PowerManagerService$PowerManagerHandler;->removeCallbacks(Ljava/lang/Runnable;)V
...
.method private goToSleepInternal(JI)V
    ...
    .line 1135
    const-string v1, "debug_power"

    new-instance v2, Ljava/lang/StringBuilder;

    invoke-direct {v2}, Ljava/lang/StringBuilder;-><init>()V

    const-string v3, "goToSleep here calling pid:"
...
.method private goToSleepNoUpdateLocked(JI)Z
    ...
    const-string v6, "ignore go to sleep because mProximityPositive"
    ...
    const-string v7, "Going to sleep due to screen prox sensor..."
...
.method private sendPendingNotificationsLocked()V
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->CHANGE_CODE:Landroid/annotation/OppoHook$OppoHookType;
        note = "TongXi.Li@Plf.Framework for assertlock and button light"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
...
.method private shouldUseProximitySensorLocked()Z
    ...
    iget v1, p0, Lcom/android/server/power/PowerManagerService;->mGotosleepReason:I
...
.method private updateLogMask(Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 2996
    :try_start_0
    sget-wide v4, Lcom/android/server/power/PowerManagerService;->mLogFlag:J

    invoke-direct {p0, p2, v4, v5}, Lcom/android/server/power/PowerManagerService;->parseLogMask([Ljava/lang/String;J)J

    move-result-wide v4

    sput-wide v4, Lcom/android/server/power/PowerManagerService;->mLogFlag:J
    ...
    :goto_2
    sput-boolean v2, Lcom/android/server/power/Notifier;->DEBUG:Z
    ...
    :goto_3
    sput-boolean v2, Lcom/android/server/power/DisplayPowerState;->DEBUG:Z
    ...
    :goto_4
    sput-boolean v2, Lcom/android/server/power/ElectronBeam;->DEBUG:Z
    ...
    .line 3006
    const-string v0, "Debug Mask State:"
    ...
    sget-wide v1, Lcom/android/server/power/PowerManagerService;->mLogFlag:J
    ...
    const-string v1, "  DEBUG_POWERMANAGER_MASK=0x"
    ...
    const-string v1, "  DEBUG_DISPLAY_CONTROLER_MASK=0x"
    ...
    const-string v1, "  DEBUG_NOTIFIER_MASK=0x"
    ...
    const-string v1, "  DEBUG_DISPLAY_POWER_STATE_MASK=0x"
    ...
    const-string v1, "  DEBUG_ELECTRON_BEAM_MASK=0x"
    ...
    const-string v1, "  DEBUG_WIRELESS_CHARGE_MASK=0x"
...
.method private updateSettingsLocked()V
    ...
    .line 658
    const-string v6, "button_light_mode"
    ...
    invoke-static {v5, v6, v11, v10}, Landroid/provider/Settings$System;->getIntForUser(Landroid/content/ContentResolver;Ljava/lang/String;II)I
    ...
    invoke-virtual {v6, v0, v1, v2}, Lcom/android/server/power/DisplayPowerController;->setButtonLightMode(IJ)V
...
.method private updateUserActivitySummaryLocked(JI)V
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->CHANGE_CODE:Landroid/annotation/OppoHook$OppoHookType;
        note = "TongXi.Li@Plf.Framework for button light"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 2454
    invoke-direct {p0, p2, p3}, Lcom/android/server/power/PowerManagerService;->updateLogMask(Ljava/io/PrintWriter;[Ljava/lang/String;)V
...
.method public monitor()V
    ...
    .line 2435
    :try_start_0
    invoke-direct {p0}, Lcom/android/server/power/PowerManagerService;->dumpWakeLocksLocked()V
...
.method public notifyKey(II)V
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/power/DisplayPowerController;->notifyKey(II)V
...
.method public turnoffBrightness()V
    ...
    invoke-virtual {v0, v2}, Lcom/android/server/power/DisplayPowerController;->setButtonLight(Z)V
