...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/android/server/power/DisplayPowerController$ButtonLight;,
...
.field private mButtonBrightnessRampAnimator:Lcom/android/server/power/RampAnimator;
...
.field private mButtonLightModeTmp:I

.field private mButtonLightState:Lcom/android/server/power/DisplayPowerController$ButtonLightState;
...
.method public constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/android/server/power/Notifier;Lcom/android/server/LightsService;Lcom/android/server/TwilightService;Landroid/hardware/SensorManager;Lcom/android/server/display/DisplayManagerService;Lcom/android/server/power/DisplayBlanker;Lcom/android/server/power/DisplayPowerController$Callbacks;Landroid/os/Handler;)V
    ...
    iput v5, p0, Lcom/android/server/power/DisplayPowerController;->mButtonLightModeTmp:I
...
.method static synthetic access$1200(Lcom/android/server/power/DisplayPowerController;)I
    ...
    .prologue
    .line 74
    iget v0, p0, Lcom/android/server/power/DisplayPowerController;->mButtonLightModeTmp:I

    return v0
.end method

.method static synthetic access$1300(Lcom/android/server/power/DisplayPowerController;)Ljava/lang/Object;
    .locals 1
    .parameter "x0"
...
.method static synthetic access$1400(Lcom/android/server/power/DisplayPowerController;)Lcom/android/server/power/DisplayPowerState;
    .locals 1
    .parameter "x0"
...
.method private initialize()V
    ...
    .line 533
    new-instance v0, Lcom/android/server/power/DisplayPowerController$ButtonLightState;

    iget-object v1, p0, Lcom/android/server/power/DisplayPowerController;->mLights:Lcom/android/server/LightsService;

    invoke-virtual {v1, v5}, Lcom/android/server/LightsService;->getLight(I)Lcom/android/server/LightsService$Light;

    move-result-object v1

    invoke-direct {v0, p0, v1}, Lcom/android/server/power/DisplayPowerController$ButtonLightState;-><init>(Lcom/android/server/power/DisplayPowerController;Lcom/android/server/LightsService$Light;)V

    iput-object v0, p0, Lcom/android/server/power/DisplayPowerController;->mButtonLightState:Lcom/android/server/power/DisplayPowerController$ButtonLightState;

    .line 534
    new-instance v0, Lcom/android/server/power/RampAnimator;

    iget-object v1, p0, Lcom/android/server/power/DisplayPowerController;->mButtonLightState:Lcom/android/server/power/DisplayPowerController$ButtonLightState;

    iget-object v2, p0, Lcom/android/server/power/DisplayPowerController;->mButtonLightState:Lcom/android/server/power/DisplayPowerController$ButtonLightState;

    iget-object v2, v2, Lcom/android/server/power/DisplayPowerController$ButtonLightState;->BUTTON_BRIGHTNESS:Landroid/util/IntProperty;

    invoke-direct {v0, v1, v2}, Lcom/android/server/power/RampAnimator;-><init>(Ljava/lang/Object;Landroid/util/IntProperty;)V

    iput-object v0, p0, Lcom/android/server/power/DisplayPowerController;->mButtonBrightnessRampAnimator:Lcom/android/server/power/RampAnimator;
...
.method private isInitiallized()Z
    .locals 2
    ...
    iget-object v0, p0, Lcom/android/server/power/DisplayPowerController;->mButtonLightState:Lcom/android/server/power/DisplayPowerController$ButtonLightState;
...
.method private setScreenOn(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/server/power/DisplayPowerController$ButtonLightState;->handleScreenOnOff(Z)V
...
.method public notifyKey(II)V
    ...
    .prologue
    .line 1379
    invoke-direct {p0}, Lcom/android/server/power/DisplayPowerController;->isInitiallized()Z
    ...
    invoke-virtual {v0, p1, p2}, Lcom/android/server/power/DisplayPowerController$ButtonLightState;->notifyKey(II)V
...
.method public setButtonLightMode(IJ)V
    .locals 1
    .parameter "mode"
    .parameter "timeout"
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/android/server/power/DisplayPowerController$ButtonLightState;->setMode(IJ)V
    ...
    .line 1387
    iput p1, p0, Lcom/android/server/power/DisplayPowerController;->mButtonLightModeTmp:I
