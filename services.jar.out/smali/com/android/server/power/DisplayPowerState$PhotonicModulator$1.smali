...
.method public run()V
    ...
    invoke-static {v6}, Lcom/android/server/power/DisplayPowerState$PhotonicModulator;->access$1200(Lcom/android/server/power/DisplayPowerState$PhotonicModulator;)Ljava/lang/Object;
    ...
    invoke-static {v7}, Lcom/android/server/power/DisplayPowerState$PhotonicModulator;->access$1300(Lcom/android/server/power/DisplayPowerState$PhotonicModulator;)Z
    ...
    invoke-static {v7}, Lcom/android/server/power/DisplayPowerState$PhotonicModulator;->access$1500(Lcom/android/server/power/DisplayPowerState$PhotonicModulator;)I
    ...
    invoke-static {v4, v5}, Lcom/android/server/power/DisplayPowerState$PhotonicModulator;->access$1702(Lcom/android/server/power/DisplayPowerState$PhotonicModulator;Z)Z
    ...
    invoke-static {v4}, Lcom/android/server/power/DisplayPowerState;->access$2000(Lcom/android/server/power/DisplayPowerState;)V
    ...
    invoke-static {v7, v2}, Lcom/android/server/power/DisplayPowerState$PhotonicModulator;->access$1402(Lcom/android/server/power/DisplayPowerState$PhotonicModulator;Z)Z

    .line 391
    iget-object v7, p0, Lcom/android/server/power/DisplayPowerState$PhotonicModulator$1;->this$1:Lcom/android/server/power/DisplayPowerState$PhotonicModulator;

    #setter for: Lcom/android/server/power/DisplayPowerState$PhotonicModulator;->mActualBacklight:I
    invoke-static {v7, v0}, Lcom/android/server/power/DisplayPowerState$PhotonicModulator;->access$1602(Lcom/android/server/power/DisplayPowerState$PhotonicModulator;I)I
    ...
    .line 394
    sget-boolean v6, Lcom/android/server/power/DisplayPowerState;->DEBUG:Z
    ...
    invoke-static {v6}, Lcom/android/server/power/DisplayPowerState;->access$1800(Lcom/android/server/power/DisplayPowerState;)Lcom/android/server/power/DisplayBlanker;
    ...
    invoke-static {v6}, Lcom/android/server/power/DisplayPowerState;->access$1900(Lcom/android/server/power/DisplayPowerState;)Lcom/android/server/LightsService$Light;
