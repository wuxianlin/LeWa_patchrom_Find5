...
.method private enqueueNotification(Landroid/net/NetworkPolicy;IJ)V
    ...
    invoke-static {v1}, Lcom/android/server/net/NetworkPolicyManagerService$Injector;->buildViewDataUsageIntent(Landroid/net/NetworkTemplate;)Landroid/content/Intent;
    ...
    .end local v16           #title:Ljava/lang/CharSequence;
    :pswitch_6
    invoke-static/range {p1 .. p4}, Lcom/android/server/net/NetworkPolicyManagerService$Injector;->getOverBytes(Landroid/net/NetworkPolicy;IJ)J
...
.method private updateNetworkEnabledLocked()V
    ...
    invoke-static {v0, v12, v10}, Lcom/android/server/net/NetworkPolicyManagerService$Injector;->setNetworkTemplateEnabled(Lcom/android/server/net/NetworkPolicyManagerService;Landroid/net/NetworkPolicy;Z)V
...
.method private writePolicyLocked()V
    ...
    invoke-static {v5, v6}, Lcom/android/server/net/NetworkPolicyManagerService$Injector;->writePolicyLocked(Lorg/xmlpull/v1/XmlSerializer;Landroid/net/NetworkPolicy;)V
...
.method private static buildViewDataUsageIntent(Landroid/net/NetworkTemplate;Landroid/content/Context;)Landroid/content/Intent;
    .locals 4
    .parameter "template"
    .parameter "context"
...
.method static callBuildNetworkOverLimitIntent(Landroid/net/NetworkTemplate;)Landroid/content/Intent;
    .locals 1
    .parameter "template"
    .annotation build Landroid/annotation/LewaHook;
        value = .enum Landroid/annotation/LewaHook$LewaHookType;->NEW_METHOD:Landroid/annotation/LewaHook$LewaHookType;
...
.method getNetworkPolicy()Ljava/util/HashMap;
    .locals 1
    .annotation build Landroid/annotation/LewaHook;
        value = .enum Landroid/annotation/LewaHook$LewaHookType;->NEW_METHOD:Landroid/annotation/LewaHook$LewaHookType;
    .end annotation
...
.method callCurrentTimeMillis()J
    .locals 2
    .annotation build Landroid/annotation/LewaHook;
        value = .enum Landroid/annotation/LewaHook$LewaHookType;->NEW_METHOD:Landroid/annotation/LewaHook$LewaHookType;
    .end annotation
...
.method callGetTotalBytes(Landroid/net/NetworkTemplate;JJ)J
    .locals 2
    .parameter "template"
    .parameter "start"
    .parameter "end"
...
.method callSetNetworkTemplateEnabled(Landroid/net/NetworkTemplate;Z)V
    .locals 0
    .parameter "template"
    .parameter "enabled"
    .annotation build Landroid/annotation/LewaHook;
