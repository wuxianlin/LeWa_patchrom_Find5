...
.method static synthetic access$100(Lcom/android/server/BatteryService;I)Z
    .locals 1
    .parameter "x0"
    .parameter "x1"
...
.method private processValuesLocked()V
    ...
    invoke-virtual {v0}, Lcom/android/server/OppoBatteryService;->getChargerVoltage()I
    ...
    iget v0, p0, Lcom/android/server/BatteryService;->checkCount:I
    ...
    iput v0, p0, Lcom/android/server/BatteryService;->checkCount:I
...
.method private shutdownIfNoPowerLocked()V
    ...
    invoke-virtual {v0}, Lcom/android/server/OppoBatteryService;->getChargeSocFall()Z
...
.method protected dump(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string v6, "Permission Denial: can\'t dump Battery service from from pid="
    ...
    .local v2, oUpdate:Z
    :try_start_0
    iget-object v8, p0, Lcom/android/server/BatteryService;->obs:Lcom/android/server/OppoBatteryService;
    ...
    invoke-virtual {v8, p1, p2, p3}, Lcom/android/server/OppoBatteryService;->dumpAddition(Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)Z
    ...
    .line 706
    :cond_2
    const-string v5, "Current Battery Service state:"

    invoke-virtual {p2, v5}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 707
    iget-boolean v5, p0, Lcom/android/server/BatteryService;->mUpdatesStopped:Z
    ...
    iget-boolean v6, p0, Lcom/android/server/BatteryService;->mAcOnline:Z
    ...
    const-string v6, "  USB powered: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v6, p0, Lcom/android/server/BatteryService;->mUsbOnline:Z
    ...
    const-string v6, "  Wireless powered: "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v5

    iget-boolean v6, p0, Lcom/android/server/BatteryService;->mWirelessOnline:Z
    ...
    iget v6, p0, Lcom/android/server/BatteryService;->mBatteryStatus:I
    ...
    iget v6, p0, Lcom/android/server/BatteryService;->mBatteryHealth:I
    ...
    iget-boolean v6, p0, Lcom/android/server/BatteryService;->mBatteryPresent:Z
    ...
    iget v6, p0, Lcom/android/server/BatteryService;->mBatteryTemperature:I
    ...
    iget-object v6, p0, Lcom/android/server/BatteryService;->mBatteryTechnology:Ljava/lang/String;
    ...
    :goto_2
    iput-boolean v5, p0, Lcom/android/server/BatteryService;->mAcOnline:Z
    ...
    :goto_4
    iput-boolean v5, p0, Lcom/android/server/BatteryService;->mUsbOnline:Z
    ...
    :goto_5
    iput-boolean v5, p0, Lcom/android/server/BatteryService;->mWirelessOnline:Z
    ...
    iput v5, p0, Lcom/android/server/BatteryService;->mBatteryStatus:I
    ...
    iput v5, p0, Lcom/android/server/BatteryService;->mBatteryLevel:I
    ...
    iput v5, p0, Lcom/android/server/BatteryService;->mInvalidCharger:I
    ...
    .line 760
    :cond_11
    const-string v5, "Dump current battery state, or:"

    invoke-virtual {p2, v5}, Ljava/io/PrintWriter;->println(Ljava/lang/String;)V

    .line 761
    const-string v5, "  set ac|usb|wireless|status|level|invalid <value>"
