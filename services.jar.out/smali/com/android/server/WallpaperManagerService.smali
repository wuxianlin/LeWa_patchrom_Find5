.class public Lcom/android/server/WallpaperManagerService;
...
.field private static final DEFAULT_WALLPAPER_RES_ID:I = 0xc080099
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_FIELD:Landroid/annotation/OppoHook$OppoHookType;
        note = "for oppo-wallpaper"
...
.field private static final MTK_PLATFORM_PROP:Ljava/lang/String; = "ro.mediatek.platform"
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_FIELD:Landroid/annotation/OppoHook$OppoHookType;
        note = "for oppo-wallpaper"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
...
.field private static mWidthOfDefaultWallpaper:I
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_FIELD:Landroid/annotation/OppoHook$OppoHookType;
        note = "for oppo-wallpaper"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
...
.method static constructor <clinit>()V
    ...
    sput v0, Lcom/android/server/WallpaperManagerService;->mWidthOfDefaultWallpaper:I
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    .line 757
    invoke-direct {p0}, Lcom/android/server/WallpaperManagerService;->getDefaultWallpaperWidth()I
...
.method static synthetic access$100(Lcom/android/server/WallpaperManagerService;)V
    ...
    .prologue
    .line 103
    invoke-direct {p0}, Lcom/android/server/WallpaperManagerService;->checkSingleWallpaper()V
...
.method private checkSingleWallpaper()V
    ...
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "to check the wallpaper bitmap and change wallpaper dimension"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation

    .prologue
    .line 312
    invoke-virtual {p0}, Lcom/android/server/WallpaperManagerService;->getWallpaperInfo()Landroid/app/WallpaperInfo;
    ...
    .line 318
    :try_start_0
    invoke-virtual {p0}, Lcom/android/server/WallpaperManagerService;->getWidthHint()I
    ...
    iget-object v12, p0, Lcom/android/server/WallpaperManagerService;->mContext:Landroid/content/Context;
    ...
    invoke-direct {p0, v0}, Lcom/android/server/WallpaperManagerService;->getCurrentImageWallpaperInfo(Landroid/graphics/Point;)V
    ...
    .line 358
    invoke-virtual {p0, v5, v4}, Lcom/android/server/WallpaperManagerService;->setDimensionHints_extra(II)V
    ...
    invoke-static {v12}, Lcom/android/server/WallpaperManagerService;->isScreenLarge(Landroid/content/Context;)Z
    ...
    invoke-static {v7, v8}, Lcom/android/server/WallpaperManagerService;->wallpaperTravelToScreenWidthRatio(II)F
    ...
    sget v13, Lcom/android/server/WallpaperManagerService;->mWidthOfDefaultWallpaper:I

    if-eq v12, v13, :cond_1

    sget v12, Lcom/android/server/WallpaperManagerService;->mWidthOfDefaultWallpaper:I

    if-eq v3, v12, :cond_1

    .line 372
    sget v5, Lcom/android/server/WallpaperManagerService;->mWidthOfDefaultWallpaper:I
...
.method private getCurrentImageWallpaperInfo(Landroid/graphics/Point;)V
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_METHOD:Landroid/annotation/OppoHook$OppoHookType;
        note = "to get the current wallpaper bitmap"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
    ...
    invoke-virtual {p0, v5, v4}, Lcom/android/server/WallpaperManagerService;->getWallpaper(Landroid/app/IWallpaperManagerCallback;Landroid/os/Bundle;)Landroid/os/ParcelFileDescriptor;
...
.method private getDefaultWallpaperWidth()I
    .locals 8
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_METHOD:Landroid/annotation/OppoHook$OppoHookType;
        note = "to get the default wallpaper width"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
...
.method public static isScreenLarge(Landroid/content/Context;)Z
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_METHOD:Landroid/annotation/OppoHook$OppoHookType;
        note = "to judge whether the screen is large"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
...
.method private loadSettingsLocked(I)V
    ...
    sget v20, Lcom/android/server/WallpaperManagerService;->mWidthOfDefaultWallpaper:I
    ...
    iput v10, v0, Lcom/android/server/WallpaperManagerService$WallpaperData;->width:I
    ...
    :cond_a
    sget v10, Lcom/android/server/WallpaperManagerService;->mWidthOfDefaultWallpaper:I
...
.method public static wallpaperTravelToScreenWidthRatio(II)F
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_METHOD:Landroid/annotation/OppoHook$OppoHookType;
        note = "to get the Screen Width Ratio"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
...
.method bindWallpaperComponentLocked(Landroid/content/ComponentName;ZZLcom/android/server/WallpaperManagerService$WallpaperData;Landroid/os/IRemoteCallback;)Z
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->CHANGE_CODE:Landroid/annotation/OppoHook$OppoHookType;
        note = "for avoiding the problem that the system crash when systemUI is removed or replaced"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
    ...
    const-string v4, "SystemUi may be removed or replaced"
...
.method public setDimensionHints_extra(II)V
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->NEW_METHOD:Landroid/annotation/OppoHook$OppoHookType;
        note = "to set the wallpaper dimension"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
...
.method public systemReady()V
    ...
    new-instance v4, Lcom/android/server/WallpaperManagerService$3;

    invoke-direct {v4, p0}, Lcom/android/server/WallpaperManagerService$3;-><init>(Lcom/android/server/WallpaperManagerService;)V
