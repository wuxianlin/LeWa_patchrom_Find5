...
.field static final LONG_PRESS_HONE_GOOGLE_NOW:I = 0x3
...
.field final mPowerLongPress:Ljava/lang/Runnable;
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "Jun.Zhang@Plf.Framework, to be used in OPPO input policy"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    .line 1981
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->bForceShowStatusBar:Z
    ...
    .line 3763
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->lastScreenOn:Z
    ...
    .line 5211
    iput-boolean v2, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHasMonkey:Z
...
.method private handleLongPressOnHome()V
    ...
    .line 897
    .local v0, currRegion:Ljava/lang/String;
    const-string v3, "CN"
    ...
    .line 917
    .end local v0           #currRegion:Ljava/lang/String;
    :cond_1
    :goto_0
    iget v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLongPressOnHomeBehavior:I
    ...
    .line 905
    .restart local v0       #currRegion:Ljava/lang/String;
    :cond_4
    iget-object v3, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mContext:Landroid/content/Context;
...
.method private interceptScreenshotChord()V
    ...
    .annotation build Landroid/annotation/OppoHook;
        level = .enum Landroid/annotation/OppoHook$OppoHookType;->CHANGE_CODE:Landroid/annotation/OppoHook$OppoHookType;
        note = "Jun.Zhang@Plf.Framework, to change time for screenCapture"
        property = .enum Landroid/annotation/OppoHook$OppoRomType;->ROM:Landroid/annotation/OppoHook$OppoRomType;
    .end annotation
...
.method public addStartingWindow(Landroid/os/IBinder;Ljava/lang/String;ILandroid/content/res/CompatibilityInfo;Ljava/lang/CharSequence;III)Landroid/view/View;
    ...
    .end local v6           #previewResource:I
    ...
    .restart local v6       #previewResource:I
...
.method public init(Landroid/content/Context;Landroid/view/IWindowManager;Landroid/view/WindowManagerPolicy$WindowManagerFuncs;)V
    ...
    iput-object v4, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBarController:Lcom/android/internal/policy/impl/BarController;
...
.method public interceptKeyBeforeDispatching(Landroid/view/WindowManagerPolicy$WindowState;Landroid/view/KeyEvent;I)J
    ...
    .line 2013
    :cond_0
    invoke-interface/range {p1 .. p1}, Landroid/view/WindowManagerPolicy$WindowState;->getShownFrameLw()Landroid/graphics/RectF;
...
.method public interceptKeyBeforeQueueing(Landroid/view/KeyEvent;IZ)I
    ...
    iget-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mSystemBooted:Z
    ...
    invoke-virtual {v0, v14, v15, v1}, Lcom/android/internal/policy/impl/PhoneWindowManager;->performHapticFeedbackLw(Landroid/view/WindowManagerPolicy$WindowState;IZ)Z
    ...
    iput-wide v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mLastTime:J
    ...
    iput-boolean v0, v1, Lcom/android/internal/policy/impl/PhoneWindowManager;->lastScreenOn:Z
    ...
    invoke-virtual {v14}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->isShowingAndNotHidden()Z
    ...
    invoke-virtual {v14}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->isShowing()Z
    ...
    .line 3845
    .local v7, isTimeOut:Z
    move-object/from16 v0, p0

    iget-object v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mKeyguardMediator:Lcom/android/internal/policy/impl/KeyguardViewMediator;

    invoke-virtual {v14}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->shouldDelayScreenOn()Z
    ...
    invoke-direct {v0, v9}, Lcom/android/internal/policy/impl/PhoneWindowManager;->isWakeKeyWhenScreenOff(I)Z
    ...
    invoke-virtual {v14, v9}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->onWakeKeyWhenKeyguardShowingTq(I)V
    ...
    iget-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyTriggered:Z
    ...
    iput-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyTriggered:Z
    ...
    iput-wide v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyTime:J
    ...
    iput-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeDownKeyConsumedByScreenshotChord:Z
    ...
    const-string v15, "interceptKeyBeforeQueueing: VOLUME key-down while ringing: Silence ringer!"

    invoke-static {v14, v15}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 3908
    invoke-interface {v13}, Lcom/android/internal/telephony/ITelephony;->silenceRinger()V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpKeyTriggered:Z
    ...
    iput-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mVolumeUpKeyTriggered:Z
    ...
    .line 3915
    .restart local v13       #telephonyService:Lcom/android/internal/telephony/ITelephony;
    :cond_13
    :try_start_1
    ...
    invoke-virtual {v0, v14, v9}, Lcom/android/internal/policy/impl/PhoneWindowManager;->handleVolumeKey(II)V
    :try_end_1
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .line 3946
    :try_start_2
    invoke-interface {v13}, Lcom/android/internal/telephony/ITelephony;->endCall()Z
    :try_end_2
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptPowerKeyDown(Z)V
    ...
    iget v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mEndcallBehavior:I
    ...
    iget-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerKeyTriggered:Z
    ...
    iput-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerKeyTriggered:Z
    ...
    iput-wide v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPowerKeyTime:J
    ...
    iget v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mIncallPowerBehavior:I
    ...
    iget-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPendingPowerKeyUpCanceled:Z
    ...
    invoke-virtual {v0, v14}, Lcom/android/internal/policy/impl/PhoneWindowManager;->interceptPowerKeyUp(Z)Z
    ...
    iput-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mPendingPowerKeyUpCanceled:Z
    ...
    .line 4018
    :try_start_5
    invoke-interface {v13}, Lcom/android/internal/telephony/ITelephony;->isIdle()Z
    :try_end_5
    ...
    iget-boolean v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->lastScreenOn:Z
    ...
    iget-object v14, v0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mBroadcastWakeLock:Landroid/os/PowerManager$WakeLock;
    ...
    invoke-virtual {v11, v14}, Landroid/os/Message;->setAsynchronous(Z)V
    ...
    const-string v15, "interceptKeyBeforeQueueing: CALL key-down while ringing: Answer the call!"

    invoke-static {v14, v15}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 4068
    invoke-interface {v13}, Lcom/android/internal/telephony/ITelephony;->answerRingingCall()V
    :try_end_6
...
.method public keyguardShowSecureApkLock(Z)V
    ...
    invoke-virtual {v0, p1}, Lcom/android/internal/policy/impl/KeyguardViewMediator;->keyguardShowSecureApkLock(Z)V
...
.method public notifyMonkey(Z)V
    .locals 0
    .parameter "monkey"

    .prologue
    .line 5213
    iput-boolean p1, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mHasMonkey:Z
...
.method public updateSettings()V
    ...
    .line 1247
    :cond_1
    const-string v12, "orientation_animation"

    const/4 v13, 0x1

    invoke-static {v3, v12, v13}, Landroid/provider/Settings$System;->getInt(Landroid/content/ContentResolver;Ljava/lang/String;I)I

    move-result v5

    .line 1249
    .local v5, rotateAnimatonValue:I
    if-eqz v5, :cond_9

    move v4, v9

    .line 1250
    .local v4, rotateAnimatonEnabled:Z
    :goto_1
    iget-boolean v12, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mRotateAnimationEnabled:Z
    ...
    iget-boolean v13, p0, Lcom/android/internal/policy/impl/PhoneWindowManager;->mRotateAnimationEnabled:Z

    invoke-interface {v12, v13}, Landroid/view/IWindowManager;->setOrientationAnimEnabled(Z)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    .catch Landroid/os/RemoteException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .end local v4           #rotateAnimatonEnabled:Z
    .end local v5           #rotateAnimatonValue:I
    ...
    .restart local v5       #rotateAnimatonValue:I
    ...
    .line 1255
    .restart local v4       #rotateAnimatonEnabled:Z
    .restart local v5       #rotateAnimatonValue:I
