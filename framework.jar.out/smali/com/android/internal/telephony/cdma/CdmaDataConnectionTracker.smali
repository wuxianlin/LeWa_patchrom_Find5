...
.method private setupData(Ljava/lang/String;)Z
    ...
    .line 359
    const-string/jumbo v5, "setupData: No free CdmaDataConnection found!"
    ...
    .line 366
    const-string/jumbo v5, "persist.telephony.cdma.protocol"
    ...
    const-string/jumbo v5, "persist.telephony.cdma.rproto"
...
.method protected onDataStateChanged(Landroid/os/AsyncResult;)V
    ...
    .line 855
    const-string/jumbo v7, "onDataStateChanged(ar): state is Inactive no changes"
    ...
    .line 885
    const-string/jumbo v7, "onDataStateChanged: No active connectionstate is CONNECTED, disconnecting/cleanup"
    ...
    .line 857
    const-string/jumbo v7, "onDataStateChanged(ar): no change"
    ...
    .line 859
    :cond_3
    const-string/jumbo v7, "onDataStateChanged(ar): there is a change"
    ...
    const-string/jumbo v8, "setTetheredCallOn for apn:"
    ...
    const-string/jumbo v8, "onDataStateChanged: IGNORE unexpected DataCallState.active="
    ...
    .line 894
    :pswitch_0
    const-string/jumbo v7, "onDataStateChanged: active=LINK_ACTIVE && CONNECTED, ignore"
    ...
    .line 902
    :pswitch_1
    const-string/jumbo v7, "onDataStateChanged active=LINK_DOWN && CONNECTED, dormant"
    ...
    const-string/jumbo v8, "onDataStateChanged: not connected, state="
