...
.field mCurrentFadeVolume:I
    .annotation build Landroid/annotation/OppoHook;
        ...
        note = "add parameters for auto adjust volume mCurrentFadeVolume"
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    iget v1, v0, Landroid/media/AudioService$AudioHandler;->mCurrentFadeVolume:I

    add-int/lit8 v1, v1, 0x1

    move-object/from16 v0, p0

    iput v1, v0, Landroid/media/AudioService$AudioHandler;->mCurrentFadeVolume:I
    ...
    invoke-virtual {v1, v2, v3, v4}, Landroid/media/AudioService;->setStreamVolume(III)V
    ...
    invoke-virtual {v1, v2, v3, v4}, Landroid/media/AudioService$AudioHandler;->sendEmptyMessageDelayed(IJ)Z
    ...
    invoke-static {v1}, Landroid/media/AudioService;->access$3700(Landroid/media/AudioService;)Ljava/lang/Boolean;
    ...
    invoke-static/range {v16 .. v16}, Landroid/media/AudioService$VolumeStreamState;->access$5400(Landroid/media/AudioService$VolumeStreamState;)I
    ...
    invoke-static {v1, v2, v3}, Landroid/media/AudioService;->access$7300(Landroid/media/AudioService;II)V
    ...
    invoke-static {v2, v1}, Landroid/media/AudioService;->access$7600(Landroid/media/AudioService;Z)V
