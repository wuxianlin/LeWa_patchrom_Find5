...
.field static final NUM_SCAN_RESULTS_PER_ITERATION:I = 0x14
...
.method public p2pConnect(Landroid/net/wifi/p2p/WifiP2pConfig;Z)Ljava/lang/String;
    ...
    const-string v8, "config.groupOwnerIntent=: "
...
.method public scanResults()Ljava/lang/String;
    ...
    const-string v9, "BSS FIRST MASK=0x1"

    .line 237
    .local v9, suppl_com:Ljava/lang/String;
    invoke-direct {p0, v9}, Landroid/net/wifi/WifiNative;->doStringCommand(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v3

    .line 245
    .local v3, first_result:Ljava/lang/String;
    if-eqz v3, :cond_0
    ...
    .line 259
    .local v2, first_id:I
    const-string v9, "BSS LAST MASK=0x1"
    ...
    .line 265
    .local v5, last_result:Ljava/lang/String;
    if-eqz v5, :cond_2
    ...
    .line 252
    .end local v2           #first_id:I
    .end local v5           #last_result:Ljava/lang/String;
    .end local v8           #result:Ljava/lang/Object;
    :catch_0
    move-exception v1
    ...
    .line 254
    .local v1, e:Ljava/lang/NumberFormatException;
    iget-object v12, p0, Landroid/net/wifi/WifiNative;->mTAG:Ljava/lang/String;

    const-string v13, "The first scan result does not have valid ID"
    ...
    .end local v1           #e:Ljava/lang/NumberFormatException;
    .end local v8           #result:Ljava/lang/Object;
    .restart local v2       #first_id:I
    .restart local v5       #last_result:Ljava/lang/String;
    :cond_3
    :try_start_1
    invoke-virtual {v0}, Ljava/lang/String;->length()I
    ...
    .line 294
    .local v10, temp_result:Ljava/lang/String;
    new-instance v12, Ljava/lang/StringBuilder;
    ...
    .line 272
    .end local v4           #last_id:I
    .end local v6           #lower_range:I
    .end local v10           #temp_result:Ljava/lang/String;
    .end local v11           #upper_range:I
    :catch_1
    move-exception v1
    ...
    const-string v13, "The last scan result does not have valid ID"
    ...
    .end local v1           #e:Ljava/lang/NumberFormatException;
    .end local v8           #result:Ljava/lang/Object;
    .restart local v4       #last_id:I
    .restart local v6       #lower_range:I
    :cond_5
    move-object v8, v7
