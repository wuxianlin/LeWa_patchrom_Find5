...
.method public dispatchUiEvent(Landroid/view/MotionEvent;II)V
    ...
    invoke-static {v0, p1, p2, p3}, Landroid/webkit/WebViewClassic;->access$7500(Landroid/webkit/WebViewClassic;Landroid/view/MotionEvent;II)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string/jumbo v42, "username"
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mAutoScrollX:I
    invoke-static/range {v41 .. v41}, Landroid/webkit/WebViewClassic;->access$2800(Landroid/webkit/WebViewClassic;)I
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mScrollingLayerRect:Landroid/graphics/Rect;
    invoke-static/range {v41 .. v41}, Landroid/webkit/WebViewClassic;->access$3300(Landroid/webkit/WebViewClassic;)Landroid/graphics/Rect;
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mAutoScrollY:I
    invoke-static/range {v42 .. v42}, Landroid/webkit/WebViewClassic;->access$2900(Landroid/webkit/WebViewClassic;)I
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mWebViewCore:Landroid/webkit/WebViewCore;
    invoke-static/range {v41 .. v41}, Landroid/webkit/WebViewClassic;->access$1600(Landroid/webkit/WebViewClassic;)Landroid/webkit/WebViewCore;

    move-result-object v41

    invoke-virtual/range {v41 .. v41}, Landroid/webkit/WebViewCore;->getInputDispatcherCallbacks()Landroid/webkit/WebViewInputDispatcher$WebKitCallbacks;
    ...
    #calls: Landroid/webkit/WebViewClassic;->getOppoManufacture()Z
    ...
    const-string v3, "com.oppo.intent.action.BROWSER_SHOW_IME"
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mFieldPointer:I
    invoke-static/range {v41 .. v41}, Landroid/webkit/WebViewClassic;->access$100(Landroid/webkit/WebViewClassic;)I
    ...
    #getter for: Landroid/webkit/WebViewClassic;->mContext:Landroid/content/Context;
    invoke-static/range {v41 .. v41}, Landroid/webkit/WebViewClassic;->access$600(Landroid/webkit/WebViewClassic;)Landroid/content/Context;
...
.method public showTapHighlight(Z)V
    ...
    invoke-static {v0}, Landroid/webkit/WebViewClassic;->access$7800(Landroid/webkit/WebViewClassic;)Z
    ...
    invoke-static {v0, p1}, Landroid/webkit/WebViewClassic;->access$7802(Landroid/webkit/WebViewClassic;Z)Z
