...
.method private loadBondState()V
    ...
    .prologue
    .line 115
    iget-object v8, p0, Landroid/server/BluetoothBondState;->mService:Landroid/server/BluetoothService;
    ...
    invoke-virtual {v8}, Landroid/server/BluetoothService;->getAdapterProperties()Landroid/server/BluetoothAdapterProperties;

    move-result-object v8

    const-string v9, "Devices"

    invoke-virtual {v8, v9}, Landroid/server/BluetoothAdapterProperties;->getProperty(Ljava/lang/String;)Ljava/lang/String;
    ...
    iget-object v8, p0, Landroid/server/BluetoothBondState;->mState:Ljava/util/HashMap;
    ...
    const-string v10, " bonded devices"
    ...
    invoke-virtual {v8, v3}, Landroid/server/BluetoothService;->getAddressFromObjectPath(Ljava/lang/String;)Ljava/lang/String;
    ...
    const-string v9, "error! address is null"
    ...
    invoke-virtual {v8, v0, v9}, Landroid/server/BluetoothService;->getUpdatedRemoteDeviceProperty(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 137
    .local v6, pairState:Ljava/lang/String;
    const-string v8, "BluetoothBondState"
    ...
    const-string v10, "The paired state of the remote device is "
    ...
    const-string v9, "error! pairState is null"
    ...
    const-string v9, "The paired state of the remote device is true"
...
.method public declared-synchronized deinitBondState()V
    .locals 1
