...
.method private initDrawables()V
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$2000(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v1}, Landroid/widget/Editor;->access$2002(Landroid/widget/Editor;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Landroid/widget/Editor;->access$2100(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0, v1}, Landroid/widget/Editor;->access$2102(Landroid/widget/Editor;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
...
.method private initHandles()V
    ...
    #getter for: Landroid/widget/Editor;->mSelectHandleLeft:Landroid/graphics/drawable/Drawable;
    invoke-static {v2}, Landroid/widget/Editor;->access$2000(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    ...
    #getter for: Landroid/widget/Editor;->mSelectHandleRight:Landroid/graphics/drawable/Drawable;
    invoke-static {v3}, Landroid/widget/Editor;->access$2100(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    ...
    #getter for: Landroid/widget/Editor;->mSelectHandleRight:Landroid/graphics/drawable/Drawable;
    invoke-static {v2}, Landroid/widget/Editor;->access$2100(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
    ...
    #getter for: Landroid/widget/Editor;->mSelectHandleLeft:Landroid/graphics/drawable/Drawable;
    invoke-static {v3}, Landroid/widget/Editor;->access$2000(Landroid/widget/Editor;)Landroid/graphics/drawable/Drawable;
...
.method public onTouchEvent(Landroid/view/MotionEvent;)V
    ...
    iget-object v11, v11, Landroid/widget/Editor;->mTextView:Landroid/widget/TextView;
    ...
    invoke-virtual {v11, v9, v10}, Landroid/widget/Editor;->isPositionOnText(FF)Z
